...
void Rusiavimas (std::vector<duom>& Duomenys, std::vector<duom>& Minksti){
    std::vector<duom>::size_type i = 0;
    while (i != Duomenys.size()) {
...
void Irasymas (std::vector<duom>& Minksti, std::vector<duom>& Duomenys){
